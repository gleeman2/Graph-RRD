...
# -- Stor2rrd/Lapr2rrd/Grafana/Graphite --
...
RUN echo "deb http://ftp.debian.org/debian stretch main non-free" >> /etc/apt/sources.list
...
EXPOSE 22 80 443 8162 8080 8081 3000
